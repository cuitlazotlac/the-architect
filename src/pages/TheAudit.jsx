...
const auditSteps = [
  {
    ...
    description:
      "A detailed questionnaire covering your current nutrition, training, lifestyle, stress levels, sleep, and goals. This gives me a full picture of where you are.",
  },
  {
    number: "02",
    title: "I review everything",
    description:
      "I take time to analyze your responses, looking for patterns, gaps, and the areas where small shifts could make the biggest impact.",
  },
  {
    number: "03",
    title: "We meet for your audit call",
    description:
      "A focused 1:1 session where I walk you through my findings and give you clear, actionable recommendations across nutrition, training, and mindset.",
  },
  {
    number: "04",
    title: "You leave with clarity",
    description:
      "A written summary of your audit with specific next steps. Whether you continue coaching with me or not, you'll know exactly where to focus.",
  },
];
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center bg-cream pt-20">
        <div className="text-center px-6 max-w-3xl hero-animate">
          ...
          <p className="text-text-light text-sm md:text-base leading-relaxed max-w-xl mx-auto">
            Before we build, we need to understand. The Audit is a comprehensive
            assessment of where you are right now — your nutrition, training,
            mindset, and lifestyle — so we can design what comes next with
            precision.
          </p>
        </div>
      </section>
          ...
          <div>
            ...
            <Reveal variant="fadeUp" delay={200}>
              <p className="text-text-light text-sm leading-[1.9] mb-6">
                The Audit is where every coaching journey begins. It's a
                deep-dive assessment designed to reveal the patterns, blind
                spots, and opportunities that most programs overlook entirely.
              </p>
            </Reveal>
            <Reveal variant="fadeUp" delay={300}>
              <p className="text-text-light text-sm leading-[1.9] mb-6">
                Most people come to coaching with a list of things they've tried
                and a belief that they just need to try harder. The Audit shows
                them something different — that the problem was never effort. It
                was understanding.
              </p>
            </Reveal>
            <Reveal variant="fadeUp" delay={400}>
              <p className="text-text-light text-sm leading-[1.9]">
                We look at everything: how you eat, how you train, how you
                sleep, how you manage stress, how your nervous system responds
                to challenge. Then we build from the truth of where you actually
                are — not where you think you should be.
              </p>
            </Reveal>
          </div>
              ...
              <Reveal key={step.number} variant="fadeUp" delay={i * 150}>
                <div className="grid grid-cols-1 md:grid-cols-[80px_1fr] gap-6 relative">
                  <div className="relative z-10 flex items-start justify-center">
                    <span className="text-bronze-dark font-serif text-3xl bg-cream-light md:bg-cream-light px-2">
                      {step.number}
                    </span>
                  </div>
                  <div>
            ...
            {[
              {
                ...
                text: "A clear look at what you're eating, why, and what your body actually needs — beyond macros and meal plans.",
              },
              {
                title: "Training Review",
                text: "An honest evaluation of your current training, what's working, what isn't, and where the gaps are.",
              },
              {
                title: "Mindset & Lifestyle Audit",
                text: "An understanding of the stress, sleep, and behavioural patterns that are influencing everything else.",
              },
            ].map((item, i) => (
        ...
        <Reveal variant="scaleUp" duration="slow">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-dark-brown text-sm leading-relaxed mb-10 max-w-lg mx-auto">
              The first step to building something different is understanding
              where you are.
            </p>
            <Link
              to="/book-online"
